...
class Square extends Shape {
  constructor(x, y) {
    let blocks = [];
    blocks.push(new Block(x, y, 'color-2'));
    blocks.push(new Block(x, y + 1, 'color-2'));
    blocks.push(new Block(x + 1, y, 'color-2'));
    blocks.push(new Block(x + 1, y + 1, 'color-2'));
    super(blocks);
  }
}
...
class LShape extends Shape {
  constructor(x, y) {
    let blocks = [];
    blocks.push(new Block(x, y, 'color-6'));
    blocks.push(new Block(x - 1, y, 'color-6'));
    blocks.push(new Block(x + 1, y, 'color-6'));
    blocks.push(new Block(x + 1, y + 1, 'color-6'));
    super(blocks);
    this.position = 0;
  }

  rotate() {
    let blocks = this.rotatePositions().map(p => new Block(p.x, p.y, 'color-6'));
    this.clear();
...
class TShape extends Shape {
  constructor(x, y) {
    let blocks = [];
    blocks.push(new Block(x, y, 'color-3'));
    blocks.push(new Block(x, y - 1, 'color-3'));
    blocks.push(new Block(x + 1, y, 'color-3'));
    blocks.push(new Block(x, y + 1, 'color-3'));
    super(blocks);
    this.position = 0;
  }
  ...
  rotate() {
    let blocks = this.rotatePositions().map(p => new Block(p.x, p.y, 'color-3'));
    this.clear();
    this.addBlocks(blocks);
    this.position = this.getNextPosition();
  }
...
class ZShape extends Shape {
  constructor(x, y) {
    let blocks = [];
    blocks.push(new Block(x, y, 'color-5'));
    blocks.push(new Block(x, y - 1, 'color-5'));
    blocks.push(new Block(x + 1, y, 'color-5'));
    blocks.push(new Block(x + 1, y + 1, 'color-5'));
    super(blocks);
    this.position = 0;
  }

  rotate() {
    let blocks = this.rotatePositions().map(p => new Block(p.x, p.y, 'color-5'));
    this.clear();
    this.addBlocks(blocks);
    this.position = this.getNextPosition();
  }
...
class Line extends Shape {
  constructor(x, y) {
    let blocks = [];
    blocks.push(new Block(x, y, 'color-1'));
    blocks.push(new Block(x - 1, y, 'color-1'));
    blocks.push(new Block(x + 1, y, 'color-1'));
    blocks.push(new Block(x + 2, y, 'color-1'));
    super(blocks);
    this.position = 0;
  }

  rotate() {
    let blocks = this.rotatePositions().map(p => new Block(p.x, p.y, 'color-1'));
    this.clear();
    this.addBlocks(blocks);
    this.position = this.getNextPosition();
  }
